...
public class AlunoResponse {
    ...
    // ✅ Mantido como STATIC para evitar loops no Jackson
    public static class HorarioAlunoDto {
        private Long id;
    ...
    public void setHorarios(List<HorarioAlunoDto> horarios) { this.horarios = horarios; }
}